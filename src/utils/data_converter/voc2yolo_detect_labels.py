...
from src.utils.data_converter.voc2yolo_utils import (
    ...
    IMAGESETS_MAIN_DIR,  # Use constant
    VOC_CLASS_TO_ID,
    parse_voc_xml,
)
...
def main():
    ...
    # Construct paths using constants from voc2yolo_utils
    voc_year_path = devkit_path / f"VOC{year}"
    imageset_file = voc_year_path / IMAGESETS_MAIN_DIR / f"{tag}.txt"
    annotations_dir = voc_year_path / ANNOTATIONS_DIR
