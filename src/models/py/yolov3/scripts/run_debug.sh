...
python -m src.models.py.yolov3.train \
  --epochs 1 \
  --batch-size 4 \
  --input-size 224 \
  --workers 2 \
...
echo "Usage:"
echo "  ./src/models/py/yolov3/scripts/run_debug.sh         # Run with 10% of data (default)"
echo "  ./src/models/py/yolov3/scripts/run_debug.sh 0.05    # Run with 5% of data"
echo "  ./src/models/py/yolov3/scripts/run_debug.sh 0.01    # Run with 1% of data"