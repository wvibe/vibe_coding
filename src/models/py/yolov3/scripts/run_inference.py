#!/usr/bin/env python
"""
Run inference with YOLOv3 model on VOC dataset images
"""
...
from src.models.py.yolov3.inference import draw_detections, get_class_names, postprocess_detections
...
# Configuration
OUTPUT_DIR = os.path.join(script_dir, "inference_results")
...
def main():
    """Run inference with YOLOv3 model"""
    # Get configuration
